    ...
    return (
        <div className='popoutBody'>
            ...
            <ul>
                ...
                <li>We then compare these predictions with the actual crime rates to attempt to ascertain how the COVID-19 pandemic may have impacted the rates of specific crimes</li>

            </ul>
            <h2 className='modalBodyTitle'>What I did (For Recruiters ( ﾟ▽ﾟ)/)</h2>
            <ul>
                <li>
                    Led the team of 4 developers through all phases of the project (planning and execution) and delegated tasks
                </li>
                <li>
                    Chose dataset and reduced startup time of application 5x over by processing the CSV to include only necessary data for model generation and comparison and using pandas
                </li>
                <li>
            ...
            <ul>
                ...
                <ul>
                    <li>
                        Green ~ P-index -100: Decrease in the number of crimes in a given month compared to predicted value using pre-covid data
                    </li>
                    <li>
                        Grey ~ P-index 0: Same number of crimes in a given month during the pandemic as predicted using pre-covid data
                    </li>
                    <li>
                        Red ~ P-index 100: Increase in the number of crimes in a given month compared to predicted value using pre-covid data
                    </li>
                </ul>
                </li>
                <li>
                    Pressing the play button shows how the number of crimes differs from their expected values for each month during the pandemic
                </li>
                <li>
